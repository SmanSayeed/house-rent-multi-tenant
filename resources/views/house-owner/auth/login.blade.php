...
<head>
    ...
    <style>
        ...
        .form-control:focus {
            border-color: var(--house-owner-primary);
...
<body>
    <div class="login-container">
        <div class="login-header">
            <i class="bi bi-house" style="font-size: 2.5rem; margin-bottom: 1rem;"></i>
        ...
        <div class="login-body">
            ...
            <form method="POST" action="{{ url('/house-owner/login') }}">
                @csrf
                ...
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary btn-login">
                        <i class="bi bi-box-arrow-in-right me-2"></i>Login to Property Manager
                    </button>
                </div>
            </form>
