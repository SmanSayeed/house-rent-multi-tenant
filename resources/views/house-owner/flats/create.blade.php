        ...
        <div class="card shadow-sm">
            <div class="card-header bg-success text-white">
                <h5 class="card-title mb-0">
                    <i class="bi bi-house-door me-2"></i>Flat Information
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('house-owner.flats.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  name="description" 
                                  rows="4" 
                                  placeholder="Optional description about the flat...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-success">
                            <i class="bi bi-check-circle me-2"></i>Create Flat
                        </button>
                        <a href="{{ route('house-owner.flats.index') }}" class="btn btn-outline-secondary">
