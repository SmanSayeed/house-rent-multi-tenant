...
@section('content')
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Bill Categories and Bills Section -->
                            <div class="mb-3">
                                <h6 class="text-muted mb-2">Bill Categories & Amounts</h6>
                                        ...
                                        @foreach ($flat->bills->groupBy('category_id') as $categoryBills)
                                            ...
                                            <div class="col-12 mb-2">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <span class="badge bg-info me-2">{{ $category->name ?? 'N/A' }}</span>
                                                    <span
                                                        class="text-success fw-bold">৳{{ number_format($categoryBills->sum('amount'), 2) }}</span>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                                @else
                                    <p class="text-muted small mb-0">No bills created yet</p>
                                @endif
                            </div>
                            ...
                            <div class="d-flex gap-2 mb-2">
                                ...
                                <form action="{{ route('house-owner.flats.destroy', $flat) }}" method="POST"
                                    class="d-inline"
                            ...
                            <div class="d-flex gap-2">
                                <a href="{{ route('house-owner.bills.create', ['flat' => $flat->id]) }}"
                                    class="btn btn-outline-info btn-sm flex-fill">
                                    <i class="bi bi-plus-circle me-1"></i>Add Bill
                                </a>
                                <a href="{{ route('house-owner.bills.index', ['flat_id' => $flat->id]) }}"
                                    class="btn btn-outline-warning btn-sm flex-fill">
                                    <i class="bi bi-receipt me-1"></i>View Bills
                                </a>
                            </div>
                        </div>
    ...
    @else
        <div class="text-center py-5">
            ...
            <p class="text-muted mb-4">You haven't added any flats yet. Start by adding your first flat to manage your
                properties.</p>
