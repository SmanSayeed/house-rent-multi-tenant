    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/house-owner/profile/update') }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="House Owner" readonly>
                            <small class="form-text text-muted">Role cannot be changed</small>
                        </div>

                        <div class="d-flex justify-content-between">
                            <a href="{{ url('/house-owner/dashboard') }}" class="btn btn-secondary">
                                <i class="bi bi-arrow-left me-2"></i>Back to Dashboard
                            </a>
                            <div>
                                <a href="{{ url('/house-owner/profile/change-password') }}" class="btn btn-warning me-2">
