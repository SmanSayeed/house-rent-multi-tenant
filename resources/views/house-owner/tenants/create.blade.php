...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0">
            <i class="bi bi-person-plus me-2"></i>Assign Tenant to Flat
        </h4>
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-success text-white">
                    <h5 class="card-title mb-0">
                        <i class="bi bi-person-check me-2"></i>Tenant Assignment Information
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('house-owner.tenants.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                @if ($availableTenants->count() === 0)
                                    <div class="form-text text-warning">
                                        ...
                                        No available tenants found. All tenants are currently assigned to flats.
                                    </div>
                                @endif
                            </div>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-success"
                                {{ $availableTenants->count() === 0 ? 'disabled' : '' }}>
                                <i class="bi bi-check-circle me-2"></i>Assign Tenant
                            </button>
                            <a href="{{ route('house-owner.tenants.index') }}" class="btn btn-outline-secondary">
